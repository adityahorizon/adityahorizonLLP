        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-brand-accent-gray rounded-lg animate-fade-in border border-brand-light-gray">
              ...
              <p className="text-sm text-brand-medium-gray">+91 79906 50121</p>
              <p className="text-sm text-brand-medium-gray">+91 98752 28078</p>
            </div>
            ...
            <div className="text-center p-6 bg-brand-accent-gray rounded-lg animate-fade-in border border-brand-light-gray" style={{ animationDelay: '0.2s' }}>
              ...
              <p className="text-sm text-brand-medium-gray">info@adityahorizoninternational.com</p>
              {/* <p className="text-sm text-brand-medium-gray">sales@adityahorizon.com</p> */}
            </div>
            
            <div className="text-center p-6 bg-brand-accent-gray rounded-lg animate-fade-in border border-brand-light-gray" style={{ animationDelay: '0.4s' }}>
              ...
              <p className="text-sm text-brand-medium-gray">Gujarat, India</p>
              <p className="text-sm text-brand-medium-gray">Manufacturing facilities in Rajkot & Ahmedabad</p>
            </div>
          </div>
        </div>
      </section>
