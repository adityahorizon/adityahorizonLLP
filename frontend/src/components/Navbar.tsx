      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            <Link
              to="/"
              className={`px-2 py-2 text-sm font-medium transition-all duration-300 relative group ${
                isActive('/') 
            ...
            <div className="relative" ref={productsRef}>
              <button
                ...
                className={`px-2 py-2 text-sm font-medium transition-all duration-300 relative group flex items-center text-brand-primary-dark hover:text-brand-secondary-orange ${
                isActive('/products') 
                  ? 'text-brand-secondary-orange' 
                  : 'text-brand-primary-dark hover:text-brand-secondary-orange'
              }`}              >
