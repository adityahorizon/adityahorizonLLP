...
//           <div className='mb-3'>
//             <h4 className="font-semibold text-lg mb-3 text-orange-400">{t('footer.quickLinks')}</h4>
...
//           <div>
//             <h4 className="font-semibold text-lg mb-3 text-orange-400">{t('footer.products')}</h4>
//             <ul className="space-y-2">
//               <li>
//                 <button
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-10 gap-x-8">
          ...
          <div>
            <h4 className="font-semibold text-lg mb-3 text-orange-400">{t('footer.quickLinks')}</h4>
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-300 hover:text-white text-sm">{t('nav.home')}</Link></li>
              <li><Link to="/about" className="text-gray-300 hover:text-white text-sm">{t('nav.about')}</Link></li>
              <li><Link to="/products" className="text-gray-300 hover:text-white text-sm">{t('nav.products')}</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-white text-sm">{t('nav.contact')}</Link></li>
              <li><Link to="/blogs" className="text-gray-300 hover:text-white text-sm">{t('nav.blogs')}</Link></li>
              <li><Link to="/glossary" className="text-gray-300 hover:text-white text-sm">Glossary</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className='w-full'>info@adityahorizoninternational.com</span>
              </a>
            </div>
          </div>
        </div>
